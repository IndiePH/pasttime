...
export const DISTRIBUTION_DATA: DistributionData = {
  crossword: {
    ...
    solveTime: [
      ...
      720, 780, 840, 900, 960, 1020, 1080, 1200, 1320, 1440,
      1560, 1680, 1800, 2100, 2400, 2700, 3000, 3600, 4200, 5400,
    ],
  },
  solitaire: {
    winRate: [
  ...
  sudoku: {
    streak: [
      ...
      21, 25, 30, 35, 40, 45, 50, 60, 75, 90,
    ],
    winRate: [
      0.5, 0.55, 0.6, 0.65, 0.7, 0.72, 0.75, 0.78, 0.8, 0.82,
      0.85, 0.87, 0.88, 0.9, 0.91, 0.92, 0.93, 0.94, 0.95, 0.96,
      0.97, 0.98, 0.99, 1.0,
    ],
    solveTime: [
      180, 240, 300, 360, 420, 480, 540, 600, 660, 720,
      780, 840, 900, 960, 1020, 1080, 1200, 1320, 1440, 1560,
      1680, 1800, 2100, 2400, 2700, 3000, 3600,
    ],
  },
}
